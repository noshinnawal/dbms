 ...
 * Renders a neomorphic form for teacher self-registration.
 */
...
<main class="min-h-screen flex items-center justify-center p-6 py-12">
    ...
    <section class="w-full max-w-2xl bg-surface-container rounded-[32px] p-8 md:p-12 shadow-[16px_16px_32px_#dbe4eb,-16px_-16px_32px_#ffffff] flex flex-col">
        ...
        <header class="w-full flex flex-col items-center mb-10">
            ...
            <h1 class="text-3xl font-bold text-on-surface text-center tracking-tight">Teacher Registration</h1>
            <p class="text-on-surface-variant text-center mt-2">Join our faculty team</p>
        </header>
        ...
        <form action="register_process.php" class="w-full flex flex-col gap-8" method="POST" id="registerForm">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Employee Number -->
                    <div class="w-full">
                        <label class="text-sm font-medium text-on-surface-variant block mb-2 ml-2" for="employee_number">Employee Number</label>
                        <input class="w-full bg-surface-container border-none rounded-2xl py-4 px-4 text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-1 focus:ring-primary/30 shadow-[inset_6px_6px_12px_#dbe4eb,inset_-6px_-6px_12px_#ffffff] transition-shadow duration-200" 
                               id="employee_number" name="employee_number" placeholder="EMP-2024-001" required type="text"/>
                    </div>
                    <!-- Department -->
                    <div class="w-full">
                        <label class="text-sm font-medium text-on-surface-variant block mb-2 ml-2" for="department">Department</label>
                        <input class="w-full bg-surface-container border-none rounded-2xl py-4 px-4 text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-1 focus:ring-primary/30 shadow-[inset_6px_6px_12px_#dbe4eb,inset_-6px_-6px_12px_#ffffff] transition-shadow duration-200" 
                               id="department" name="department" placeholder="Computer Science" required type="text"/>
                    </div>
                    <!-- Title -->
                    <div class="w-full">
                        <label class="text-sm font-medium text-on-surface-variant block mb-2 ml-2" for="title">Academic Title</label>
                        <input class="w-full bg-surface-container border-none rounded-2xl py-4 px-4 text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-1 focus:ring-primary/30 shadow-[inset_6px_6px_12px_#dbe4eb,inset_-6px_-6px_12px_#ffffff] transition-shadow duration-200" 
                               id="title" name="title" placeholder="Assistant Professor" required type="text"/>
                    </div>
                    <!-- Hire Date -->
                    <div class="w-full">
                        <label class="text-sm font-medium text-on-surface-variant block mb-2 ml-2" for="hire_date">Hire Date</label>
                        <input class="w-full bg-surface-container border-none rounded-2xl py-4 px-4 text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-1 focus:ring-primary/30 shadow-[inset_6px_6px_12px_#dbe4eb,inset_-6px_-6px_12px_#ffffff] transition-shadow duration-200" 
                               id="hire_date" name="hire_date" required type="date"/>
                    </div>
                    <!-- Office Location -->
                    <div class="w-full md:col-span-2">
                        <label class="text-sm font-medium text-on-surface-variant block mb-2 ml-2" for="office_location">Office Location</label>
                        <input class="w-full bg-surface-container border-none rounded-2xl py-4 px-4 text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-1 focus:ring-primary/30 shadow-[inset_6px_6px_12px_#dbe4eb,inset_-6px_-6px_12px_#ffffff] transition-shadow duration-200" 
                               id="office_location" name="office_location" placeholder="Building A, Room 302" required type="text"/>
                    </div>
                </div>
            </div>
